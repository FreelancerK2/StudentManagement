...
public:
    ...
    virtual void save(std::ofstream &out) const {                  
        out.write(reinterpret_cast<const char*>(&courseID), sizeof(courseID));// return object in byte
        size_t nameLength = courseName.size();
        out.write(reinterpret_cast<const char*>(&nameLength), sizeof(nameLength));
        out.write(courseName.c_str(), nameLength);     // c_str convert string to array of char {'c','o', 'u', 'r', 's', 'e',}
